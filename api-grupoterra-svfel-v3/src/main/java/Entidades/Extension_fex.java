...
public class Extension_fex implements Serializable {
    ...
    public Extension_fex(String nombEntrega, String docuEntrega, String nombRecibe, String docuRecibe, String observaciones, String placaVehiculo) {
    ...
    public String toString() {
        return "Extension_fex{" + "nombEntrega=" + nombEntrega + ", docuEntrega=" + docuEntrega + ", nombRecibe=" + nombRecibe + ", docuRecibe=" + docuRecibe + ", observaciones=" + observaciones + ", placaVehiculo=" + placaVehiculo + '}';
    }
