...
SELECT F.* FROM DTE_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM IDENTIFICACION_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM DOCU_RELA_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM RECEPTOR_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM SHIPTO_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM OTROS_DOCU_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM VENTA_TERCERO_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM CUERPO_DOCU_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM CUERPO_TRIBUTO_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM RESUMEN_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM RESUMEN_TRIBUTO_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM EXTENSION_F_V3 F WHERE F.ID_DTE IN (10);
SELECT F.* FROM APENDICE_F_V3 F WHERE F.ID_DTE IN (10);
...
SELECT F.* FROM DTE_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM IDENTIFICACION_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM RECEPTOR_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM SHIPTO_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM OTROS_DOCU_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM VENTA_TERCERO_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM CUERPO_DOCU_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM CUERPO_TRIBUTO_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM RESUMEN_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM RESUMEN_TRIBUTO_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM EXTENSION_FEX_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM APENDICE_FEX_V3 F WHERE F.ID_DTE IN (1);
...
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='S3' AND F.FEDCT='PA';
SELECT F.* FROM CRPDTA.F42119@JDEPY F WHERE F.SDDOCO IN (SELECT F.FEDOCO FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='S3' AND F.FEDCT='PA');
UPDATE CRPDTA.F42119@JDEPY SET SDCRMD=NULL WHERE SDDOCO IN (SELECT F.FEDOCO FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='S3' AND F.FEDCT='PA');
DELETE FROM CRPDTA.F5542FEL@JDEPY WHERE FEDCTO='S3' AND FEDCT='PA';
COMMIT;

SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F;
SELECT F.FEDCTO, COUNT(*) NUMERO FROM CRPDTA.F5542FEL@JDEPY F GROUP BY F.FEDCTO;
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='FE';
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='FE' AND F.FESTCD NOT IN ('001','002');
SELECT F.FEAN8, COUNT(*) NUMERO FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='FE' AND F.FESTCD NOT IN ('001','002') GROUP BY F.FEAN8;

SELECT F.* FROM CRPDTA.F4211@JDEPY F WHERE F.SDDOCO=72959527 AND F.SDDCTO='S3';

SELECT F.* FROM DTE_F_V3 F WHERE F.DOCO_JDE=72959524;