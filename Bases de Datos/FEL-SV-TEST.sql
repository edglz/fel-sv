...
SELECT F.* FROM DTE_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM IDENTIFICACION_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM DOCU_RELA_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM RECEPTOR_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM SHIPTO_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM OTROS_DOCU_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM VENTA_TERCERO_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM CUERPO_DOCU_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM CUERPO_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM RESUMEN_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM RESUMEN_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM EXTENSION_CCF_V3 F WHERE F.ID_DTE IN (355);
SELECT F.* FROM APENDICE_CCF_V3 F WHERE F.ID_DTE IN (355);
-- ***************************************************************************************************************************
-- *          NOTA DE CRÉDITO.                                                                                               *
-- ***************************************************************************************************************************
...
SELECT F.SDTXA1, F.* FROM CRPDTA.F42119@JDEPY F WHERE F.SDDOCO IN (72959969);
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDOCO IN (72959969);

-- UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000', FEJEVER='F42119    ' WHERE FEDOCO IN (72959969);
UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000' WHERE FEDOCO IN (72959969);
COMMIT;
