...
public class Cliente_Rest_SendMail implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final String BASE_URI = "http://10.254.7.203:9191/UTILS/webapi/Mail/send";
    private ClientConfig clientConfig;
    private Client client;

    public Cliente_Rest_SendMail() {
        try {
