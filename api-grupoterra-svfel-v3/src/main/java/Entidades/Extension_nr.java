...
public class Extension_nr implements Serializable {
    ...
    public Extension_nr(String nombEntrega, String docuEntrega, String nombRecibe, String docuRecibe, String observaciones) {
    ...
    public String toString() {
        return "Extension_nr{" + "nombEntrega=" + nombEntrega + ", docuEntrega=" + docuEntrega + ", nombRecibe=" + nombRecibe + ", docuRecibe=" + docuRecibe + ", observaciones=" + observaciones + '}';
    }
