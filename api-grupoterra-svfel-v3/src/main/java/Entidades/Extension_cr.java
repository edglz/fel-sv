...
public class Extension_cr implements Serializable {
    ...
    public Extension_cr(String nombEntrega, String docuEntrega, String nombRecibe, String docuRecibe, String observaciones) {
    ...
    public String toString() {
        return "Extension_cr{" + "nombEntrega=" + nombEntrega + ", docuEntrega=" + docuEntrega + ", nombRecibe=" + nombRecibe + ", docuRecibe=" + docuRecibe + ", observaciones=" + observaciones + '}';
    }
