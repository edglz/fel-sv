...
public class Extension_f implements Serializable {
    ...
    public Extension_f(String nombEntrega, String docuEntrega, String nombRecibe, String docuRecibe, String observaciones, String placaVehiculo) {
    ...
    public String toString() {
        return "Extension_f{" + "nombEntrega=" + nombEntrega + ", docuEntrega=" + docuEntrega + ", nombRecibe=" + nombRecibe + ", docuRecibe=" + docuRecibe + ", observaciones=" + observaciones + ", placaVehiculo=" + placaVehiculo + '}';
    }
