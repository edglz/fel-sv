...
public class Ctrl_Apendice_NC_V3 implements Serializable {

    private static final long serialVersionUID = 1L;

    public Ctrl_Apendice_NC_V3() {
    }

    public List<Apendice_nc> obtener_apendice_nc_v3(Long id_dte, Connection conn) {
        List<Apendice_nc> resultado = new ArrayList<>();

        try {
            Ctrl_Base_Datos ctrl_base_datos = new Ctrl_Base_Datos();
            
            String cadenasql = "SELECT F.ID_APENDICE FROM APENDICE_NC_V3 F WHERE F.ID_DTE=" + id_dte + " ORDER BY F.ID_APENDICE"; 
            ...
            System.out.println("PROYECTO:api-grupoterra-svfel-v3|CLASE:" + this.getClass().getName() + "|METODO:obtener_apendice_nc_v3()|ERROR:" + ex.toString());
        }

        return resultado;
    }
    
    public String extraer_apendice_jde_nc_v3(Long id_dte, String ambiente, String DOCO_JDE, String DCTO_JDE, String MCU_JDE, Connection conn) {
        String resultado = "";
        ...
        try {
            ...
            String cadenasql = "INSERT INTO APENDICE_NC_V3 ("
                    + "ID_DTE, "
                    + "ID_APENDICE, "
                    + "CAMPO, "
                    + "ETIQUETA, "
            ...
            String AN8_JDE = ctrl_base_datos.ObtenerString("SELECT F.AN8_JDE FROM DTE_NC_V3 F WHERE F.ID_DTE=" + ID_DTE, conn);
            ...
            System.out.println("PROYECTO:api-grupoterra-svfel-v3|CLASE:" + this.getClass().getName() + "|METODO:extraer_apendice_jde_nc_v3()|ERROR:" + ex.toString());
        }
