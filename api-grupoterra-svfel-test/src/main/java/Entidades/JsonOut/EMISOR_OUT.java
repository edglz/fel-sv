...
public class EMISOR_OUT implements Serializable {
    ...
    private MEDICO_OUT medico;
    private String cartaVenta;

    public EMISOR_OUT(String nit, String nrc, String numFacturador, String nombre, ACTIVIDAD_ECONOMICA_OUT actividad1, ACTIVIDAD_ECONOMICA_OUT actividad2, String nombreComercial, DIRECCION_OUT direccion, String telefono, String correo, Integer categoria, Integer tipoEstablecimiento, SUCURSAL_OUT sucursal, String fecSujExcl, MEDICO_OUT medico, String cartaVenta) {
        this.nit = nit;
        this.nrc = nrc;
    ...
    public MEDICO_OUT getMedico() {
        return medico;
    }

    public void setMedico(MEDICO_OUT medico) {
        this.medico = medico;
    }

    public String getCartaVenta() {
        return cartaVenta;
    }

    public void setCartaVenta(String cartaVenta) {
        this.cartaVenta = cartaVenta;
    }

    @Override
    public String toString() {
        return "EMISOR_OUT{" + "nit=" + nit + ", nrc=" + nrc + ", numFacturador=" + numFacturador + ", nombre=" + nombre + ", actividad1=" + actividad1 + ", actividad2=" + actividad2 + ", nombreComercial=" + nombreComercial + ", direccion=" + direccion + ", telefono=" + telefono + ", correo=" + correo + ", categoria=" + categoria + ", tipoEstablecimiento=" + tipoEstablecimiento + ", sucursal=" + sucursal + ", fecSujExcl=" + fecSujExcl + ", medico=" + medico + ", cartaVenta=" + cartaVenta + '}';
    }
