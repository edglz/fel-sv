...
SELECT F.* FROM DTE_CCF_V3 F WHERE F.DOCO_JDE IN (72959685) ORDER BY F.ID_DTE DESC;
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDOCO IN (72959685);

-- UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000', FEJEVER='F42119    ' WHERE FEDOCO IN (72959573,72959602);
UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000' WHERE FEDOCO IN (72959510,72959511);
COMMIT;
