...
public class CuerpoDocumento_nd implements Serializable {
    ...
    public CuerpoDocumento_nd(Number numItem, Number tipoItem, String numeroDocumento, Number cantidad, String codigo, String codTributo, Number uniMedida, String descripcion, Number precioUni, Number montoDescu, Number ventaNoSuj, Number ventaExenta, Number ventaGravada, List<String> tributos) {
