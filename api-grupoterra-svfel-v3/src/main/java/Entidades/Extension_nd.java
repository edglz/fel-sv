...
public class Extension_nd implements Serializable {
    ...
    public Extension_nd(String nombEntrega, String docuEntrega, String nombRecibe, String docuRecibe, String observaciones) {
