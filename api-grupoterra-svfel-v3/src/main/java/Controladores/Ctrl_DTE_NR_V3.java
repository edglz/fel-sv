        ...
        try {
            ...
            while (rs.next()) {
                ...
                cadenasql = "UPDATE " + esquema + ".F5542FEL@" + dblink + " "
                        + "SET FESTCD='999' "
                        + "WHERE FEKCOO='" + KCOO_JDE + "' AND FEDOCO=" + DOCO_JDE + " AND FEDCTO='NR' AND FEDOC=" + DOC_JDE + " AND FEDCT='" + DCT_JDE + "'";
                ...
                String result_identificacion = ctrl_identificacion_nr_v3.extraer_identificacion_jde_nr_v3(ID_DTE, ambiente, DCTO_JDE.trim(), MCU_JDE.trim(), CRCD_JDE.trim(), conn);
