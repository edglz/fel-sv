...
public class Emisor_f implements Serializable {
    ...
    public Emisor_f(String nit, String nrc, String nombre, String codActividad, String descActividad, String nombreComercial, String tipoEstablecimiento, Direccion direccion, String telefono, String codEstableMH, String codEstable, String codPuntoVentaMH, String codPuntoVenta, String correo) {
        this.nit = nit;
        this.nrc = nrc;
        this.nombre = nombre;
