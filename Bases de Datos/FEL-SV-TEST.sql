...
SELECT F.* FROM DTE_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM IDENTIFICACION_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM DOCU_RELA_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM RECEPTOR_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM SHIPTO_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM OTROS_DOCU_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM VENTA_TERCERO_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM CUERPO_DOCU_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM CUERPO_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM RESUMEN_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM RESUMEN_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM EXTENSION_CCF_V3 F WHERE F.ID_DTE IN (368);
SELECT F.* FROM APENDICE_CCF_V3 F WHERE F.ID_DTE IN (368);
-- ***************************************************************************************************************************
-- *          NOTA DE CRÉDITO.                                                                                               *
-- ***************************************************************************************************************************
...
SELECT F.* FROM DTE_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM IDENTIFICACION_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM DOCU_RELA_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM RECEPTOR_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM SHIPTO_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM OTROS_DOCU_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM VENTA_TERCERO_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM CUERPO_DOCU_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM CUERPO_TRIBUTO_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM RESUMEN_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM RESUMEN_TRIBUTO_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM EXTENSION_NR_V3 F WHERE F.ID_DTE IN (29);
SELECT F.* FROM APENDICE_NR_V3 F WHERE F.ID_DTE IN (63);
-- ***************************************************************************************************************************
...
SELECT F.* FROM DTE_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM IDENTIFICACION_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM DOCU_RELA_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM RECEPTOR_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM SHIPTO_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM OTROS_DOCU_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM VENTA_TERCERO_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM CUERPO_DOCU_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM CUERPO_TRIBUTO_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM RESUMEN_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM RESUMEN_TRIBUTO_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM EXTENSION_CR_V3 F WHERE F.ID_DTE IN (12);
SELECT F.* FROM APENDICE_CR_V3 F WHERE F.ID_DTE IN (12);
-- ***************************************************************************************************************************
...
WHERE (TRIM(F.NRKCOO) IN (SELECT C.KCOO_JDE FROM EMISOR_KCOO_V3 C)) AND (F.NRN001 > 0) AND (TRIM(F.NRLTTR) NOT IN ('904','902','900','980')) AND (TRIM(F.NRDCTO) IN ('S3')) AND (TRIM(F.NREV01) IN ('N')) AND (F.NRURDT = 123135)
...
WHERE (TRIM(F.CRKCO) IN (SELECT C.KCOO_JDE FROM EMISOR_KCOO_V3 C)) AND (F.CRN001 > 0) AND (TRIM(F.CREV01) IN ('N')) AND (F.CRDIVJ >= 123133);

SELECT F.SDTXA1, F.* FROM CRPDTA.F4211@JDEPY F WHERE F.SDDOCO IN (49);
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDOCO IN (49);
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='CR';
-- UPDATE CRPDTA.F5542FEL@JDEPY SET FEMCU='      728012' WHERE FEDOCO IN (47,56);
-- COMMIT;

-- UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000', FEJEVER='F42119    ' WHERE FEDOCO IN (72960037);
UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000' WHERE FEDOCO IN (47,56);
COMMIT;
