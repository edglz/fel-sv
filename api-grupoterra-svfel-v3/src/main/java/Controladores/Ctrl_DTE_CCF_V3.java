    ...
    public List<Long> extraer_documento_jde_ccf_v3(String ambiente) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String result_identificacion = ctrl_identificacion_ccf_v3.extraer_identificacion_jde_ccf_v3(ID_DTE, ambiente, DCTO_JDE.trim(), MCU_JDE.trim(), CRCD_JDE.trim(), conn);
