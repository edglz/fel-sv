...
SELECT F.* FROM APENDICE_NR_V3 F WHERE F.ID_DTE IN (29);
-- ***************************************************************************************************************************
-- *          COMPROBANTE DE CRÉDITO FISCAL.                                                                                 *
-- ***************************************************************************************************************************
...
SELECT F.SDTXA1, F.* FROM CRPDTA.F4211@JDEPY F WHERE F.SDDOCO IN (72960035);
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDOCO IN (72960035);

-- UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000', FEJEVER='F42119    ' WHERE FEDOCO IN (72960037);
UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000' WHERE FEDOCO IN (72960035);
COMMIT;
