...
public class Identificacion_f implements Serializable {
    ...
    public Identificacion_f(Number version, String ambiente, String tipoDte, String numeroControl, String codigoGeneracion, Number tipoModelo, Number tipoOperacion, Number tipoContingencia, String motivoContin, String fecEmi, String horEmi, String tipoMoneda) {
    ...
    public String toString() {
        return "Identificacion_f{" + "version=" + version + ", ambiente=" + ambiente + ", tipoDte=" + tipoDte + ", numeroControl=" + numeroControl + ", codigoGeneracion=" + codigoGeneracion + ", tipoModelo=" + tipoModelo + ", tipoOperacion=" + tipoOperacion + ", tipoContingencia=" + tipoContingencia + ", motivoContin=" + motivoContin + ", fecEmi=" + fecEmi + ", horEmi=" + horEmi + ", tipoMoneda=" + tipoMoneda + '}';
    }
