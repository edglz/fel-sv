...
public class CUERPO_DOCUMENTO_IN implements Serializable {
    ...
    public CUERPO_DOCUMENTO_IN(Integer numItem, Integer tipoItem, Number cantidad, String codigo, Integer uniMedida, String descripcion, Number precioUni, Number montoDescu, Number ventaNoSuj, Number ventaExenta, Number ventaGravada, List<Integer> tributos, Number psv, Number diferencial, Number noGravado) {
