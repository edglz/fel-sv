...
public class Resumen_ccf implements Serializable {
    ...
    public Resumen_ccf(Number totalNoSuj, Number totalExenta, Number totalGravada, Number subTotalVentas, Number descuNoSuj, Number descuExenta, Number descuGravada, Number porcentajeDescuento, Number totalDescu, List<Tributo> tributos, Number subTotal, Number ivaPerci1, Number ivaRete1, Number reteRenta, Number montoTotalOperacion, Number totalNoGravado, Number totalPagar, String totalLetras, Number saldoFavor, Number condicionOperacion, Pagos pagos, String numPagoElectronico) {
    ...
    public String toString() {
        return "Resumen_ccf{" + "totalNoSuj=" + totalNoSuj + ", totalExenta=" + totalExenta + ", totalGravada=" + totalGravada + ", subTotalVentas=" + subTotalVentas + ", descuNoSuj=" + descuNoSuj + ", descuExenta=" + descuExenta + ", descuGravada=" + descuGravada + ", porcentajeDescuento=" + porcentajeDescuento + ", totalDescu=" + totalDescu + ", tributos=" + tributos + ", subTotal=" + subTotal + ", ivaPerci1=" + ivaPerci1 + ", ivaRete1=" + ivaRete1 + ", reteRenta=" + reteRenta + ", montoTotalOperacion=" + montoTotalOperacion + ", totalNoGravado=" + totalNoGravado + ", totalPagar=" + totalPagar + ", totalLetras=" + totalLetras + ", saldoFavor=" + saldoFavor + ", condicionOperacion=" + condicionOperacion + ", pagos=" + pagos + ", numPagoElectronico=" + numPagoElectronico + '}';
    }
