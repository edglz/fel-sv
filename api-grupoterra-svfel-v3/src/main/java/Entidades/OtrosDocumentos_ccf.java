...
public class OtrosDocumentos_ccf implements Serializable {
    ...
    public OtrosDocumentos_ccf(Integer codDocAsociado, String descDocumento, String detalleDocumento, String nombre, String nit, String docIdentificacion, Number tipoServicio) {
    ...
    public String toString() {
        return "OtrosDocumentos_ccf{" + "codDocAsociado=" + codDocAsociado + ", descDocumento=" + descDocumento + ", detalleDocumento=" + detalleDocumento + ", nombre=" + nombre + ", nit=" + nit + ", docIdentificacion=" + docIdentificacion + ", tipoServicio=" + tipoServicio + '}';
    }
