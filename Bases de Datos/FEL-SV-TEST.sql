...
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='CR' AND F.FEDOCO IN (60);
...
UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000' WHERE FEDCTO='CR' AND FEDOCO IN (200);
COMMIT;


SELECT F.* FROM CRPDTA.F5504001@JDEPY F WHERE F.CRURCD='XR' AND F.CRN001=60;
UPDATE CRPDTA.F5504001@JDEPY SET CRDIVJ=123157 WHERE CRURCD='XR' AND CRN001=60;
COMMIT;

SELECT F.* FROM CRPDTA.F550401A@JDEPY F WHERE TRIM(F.A9TAX)='3445';
