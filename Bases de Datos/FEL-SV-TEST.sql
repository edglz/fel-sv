...
SELECT F.* FROM DTE_F_V3 F WHERE F.ID_DTE IN (8);
SELECT F.* FROM IDENTIFICACION_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM DOCU_RELA_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM RECEPTOR_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM SHIPTO_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM OTROS_DOCU_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM VENTA_TERCERO_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM CUERPO_DOCU_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM CUERPO_TRIBUTO_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM RESUMEN_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM RESUMEN_TRIBUTO_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM EXTENSION_F_V3 F WHERE F.ID_DTE IN (6);
SELECT F.* FROM APENDICE_F_V3 F WHERE F.ID_DTE IN (6);
