...
UPDATE NOTIFIACION_CORREO_V3 SET ACTIVO=1 WHERE ID_NOTIFICACION IN (1,3,4,7,8,9,10,11,12,13,14,15); -- NOTIFIACIÓN EN FASE DE PRUEBAS INTEGRALES.
...
SELECT F.* FROM DTE_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM IDENTIFICACION_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM DOCU_RELA_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM RECEPTOR_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM SHIPTO_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM OTROS_DOCU_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM VENTA_TERCERO_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM CUERPO_DOCU_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM CUERPO_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM RESUMEN_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM RESUMEN_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM EXTENSION_CCF_V3 F WHERE F.ID_DTE IN (385);
SELECT F.* FROM APENDICE_CCF_V3 F WHERE F.ID_DTE IN (385);
-- ***************************************************************************************************************************
-- *          NOTA DE CRÉDITO.                                                                                               *
-- ***************************************************************************************************************************
...
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDOCO IN (200);

-- UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000', FEJEVER='F42119    ' WHERE FEDOCO IN (72960056);
-- UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000' WHERE FEDOCO IN (240,239,238);
-- COMMIT;

SELECT F.* FROM CRPDTA.F5504001@JDEPY F WHERE F.CRAN8=0;
SELECT F.* FROM CRPDTA.F5504001@JDEPY F WHERE F.CRKCO='00733' AND F.CRURCD='XR' AND F.CRN001=200;
UPDATE CRPDTA.F5504001@JDEPY SET CRDIVJ=123158, CREV01='N', CRMCU='      728003' WHERE CRKCO='00733' AND CRURCD='XR' AND CRN001=200;
COMMIT;
