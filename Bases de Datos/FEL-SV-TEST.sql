...
SELECT F.SDTXA1, F.* FROM CRPDTA.F4211@JDEPY F WHERE F.SDDOCO IN (72959974);
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDOCO IN (72959974);

-- UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000', FEJEVER='F42119    ' WHERE FEDOCO IN (72940449);
UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000' WHERE FEDOCO IN (72959771);
COMMIT;
