...
public class Identificacion_cr implements Serializable {
    ...
    public Identificacion_cr(Number version, String ambiente, String tipoDte, String numeroControl, String codigoGeneracion, Number tipoModelo, Number tipoOperacion, Number tipoContingencia, String motivoContin, String fecEmi, String horEmi, String tipoMoneda) {
    ...
    public String toString() {
        return "Identificacion_cr{" + "version=" + version + ", ambiente=" + ambiente + ", tipoDte=" + tipoDte + ", numeroControl=" + numeroControl + ", codigoGeneracion=" + codigoGeneracion + ", tipoModelo=" + tipoModelo + ", tipoOperacion=" + tipoOperacion + ", tipoContingencia=" + tipoContingencia + ", motivoContin=" + motivoContin + ", fecEmi=" + fecEmi + ", horEmi=" + horEmi + ", tipoMoneda=" + tipoMoneda + '}';
    }
