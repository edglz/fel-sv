...
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDCTO='S3' AND F.FESTCD='999' AND F.FEDOCO IN (72940498,72940789,72940464,72940462,72940793,72940535,72940482,72940491,72940461,72940500);
UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000', FECRSREF01='-', FECRSREF02='-', FECRSREF03='-', FECRSREF04='-', FECRSREF05='-' WHERE FEDOCO IN (72940498,72940789,72940464,72940462,72940793,72940535,72940482,72940491,72940461,72940500);
COMMIT;

SELECT F.* FROM DTE_CCF_V3 F WHERE F.DOCO_JDE=72959053;
...
SELECT F.* FROM RECEPTOR_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM SHIPTO_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM VENTA_TERCERO_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM CUERPO_DOCU_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM CUERPO_TRIBUTO_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM CUERPO_DOCU_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM CUERPO_TRIBUTO_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM RESUMEN_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM RESUMEN_TRIBUTO_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM EXTENSION_NC_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM APENDICE_NC_V3 F WHERE F.ID_DTE IN (1);
