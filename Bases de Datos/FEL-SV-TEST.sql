...
SELECT F.* FROM DTE_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM IDENTIFICACION_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM DOCU_RELA_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM RECEPTOR_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM SHIPTO_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM VENTA_TERCERO_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM CUERPO_DOCU_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM CUERPO_TRIBUTO_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM RESUMEN_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM RESUMEN_TRIBUTO_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM EXTENSION_NC_V3 F WHERE F.ID_DTE IN (9);
SELECT F.* FROM APENDICE_NC_V3 F WHERE F.ID_DTE IN (9);
