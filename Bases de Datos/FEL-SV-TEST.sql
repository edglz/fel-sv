...
UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000', FECRSREF01='-', FECRSREF02='-', FECRSREF03='-', FECRSREF04='-', FECRSREF05='-' WHERE FEDOCO IN (3042763);
COMMIT;
...
SELECT F.* FROM DTE_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM IDENTIFICACION_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM DOCU_RELA_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM RECEPTOR_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM SHIPTO_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM OTROS_DOCU_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM VENTA_TERCERO_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM CUERPO_DOCU_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM CUERPO_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM RESUMEN_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM RESUMEN_TRIBUTO_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM EXTENSION_CCF_V3 F WHERE F.ID_DTE IN (207);
SELECT F.* FROM APENDICE_CCF_V3 F WHERE F.ID_DTE IN (207);
...
SELECT F.* FROM DTE_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM IDENTIFICACION_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM DOCU_RELA_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM RECEPTOR_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM SHIPTO_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM VENTA_TERCERO_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM CUERPO_DOCU_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM CUERPO_TRIBUTO_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM RESUMEN_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM RESUMEN_TRIBUTO_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM EXTENSION_NC_V3 F WHERE F.ID_DTE IN (5);
SELECT F.* FROM APENDICE_NC_V3 F WHERE F.ID_DTE IN (5);
...
SELECT TRIM(F.SHTXCT) ANULA, F.* FROM CRPDTA.F4201@JDEPY F WHERE F.SHKCOO='00728' AND F.SHDOCO=3042763 AND F.SHDCTO='C3';
SELECT TRIM(F.SHTXCT) ANULA, F.* FROM CRPDTA.F4201@JDEPY F WHERE F.SHKCOO='00728' AND F.SHDOCO=3042764 AND F.SHDCTO='C3';
SELECT TRIM(F.SHTXCT) ANULA, F.* FROM CRPDTA.F4201@JDEPY F WHERE F.SHKCOO='00728' AND F.SHDOCO=3042765 AND F.SHDCTO='C3';

SELECT F.SDDCTO || '-' || F.SDDOCO ANULA, F.SDLTTR, F.SDNXTR, F.* FROM CRPDTA.F42119@JDEPY F WHERE F.SDDCT='BI' AND F.SDDOC=22023942;
SELECT F.SDDCTO || '-' || F.SDDOCO ANULA, F.SDLTTR, F.SDNXTR, F.* FROM CRPDTA.F42119@JDEPY F WHERE F.SDDCT='BI' AND F.SDDOC=22023943;
SELECT F.SDDCTO || '-' || F.SDDOCO ANULA, F.SDLTTR, F.SDNXTR, F.* FROM CRPDTA.F42119@JDEPY F WHERE F.SDDCT='BI' AND F.SDDOC=22023944;

UPDATE CRPDTA.F4201@JDEPY SET SHTXCT='S3-77902791' WHERE SHKCOO='00728' AND SHDOCO=3042763 AND SHDCTO='C3';
UPDATE CRPDTA.F4201@JDEPY SET SHTXCT='S3-77902775' WHERE SHKCOO='00728' AND SHDOCO=3042764 AND SHDCTO='C3';
UPDATE CRPDTA.F4201@JDEPY SET SHTXCT='S3-77902757' WHERE SHKCOO='00728' AND SHDOCO=3042765 AND SHDCTO='C3';
COMMIT;
