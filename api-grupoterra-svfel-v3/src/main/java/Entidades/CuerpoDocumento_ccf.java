...
public class CuerpoDocumento_ccf implements Serializable {
    ...
    public CuerpoDocumento_ccf(Number numItem, Number tipoItem, String numeroDocumento, Number cantidad, String codigo, String codTributo, Number uniMedida, String descripcion, Number precioUni, Number montoDescu, Number ventaNoSuj, Number ventaExenta, Number ventaGravada, List<String> tributos, Number psv, Number noGravado) {
    ...
    public String toString() {
        return "CuerpoDocumento_ccf{" + "numItem=" + numItem + ", tipoItem=" + tipoItem + ", numeroDocumento=" + numeroDocumento + ", cantidad=" + cantidad + ", codigo=" + codigo + ", codTributo=" + codTributo + ", uniMedida=" + uniMedida + ", descripcion=" + descripcion + ", precioUni=" + precioUni + ", montoDescu=" + montoDescu + ", ventaNoSuj=" + ventaNoSuj + ", ventaExenta=" + ventaExenta + ", ventaGravada=" + ventaGravada + ", tributos=" + tributos + ", psv=" + psv + ", noGravado=" + noGravado + '}';
    }
