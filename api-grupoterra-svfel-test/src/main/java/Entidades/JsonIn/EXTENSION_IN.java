...
public class EXTENSION_IN implements Serializable {
    ...
    public EXTENSION_IN(Number totalItems, Number totalDescu, String nombEntrega, String docuEntrega, String codEmpleado, String nombRecibe, String docuRecibe, String observaciones, String placaVehiculo, String autoFitoSanitaria) {
    ...
    public String toString() {
        return "EXTENSION_IN{" + "totalItems=" + totalItems + ", totalDescu=" + totalDescu + ", nombEntrega=" + nombEntrega + ", docuEntrega=" + docuEntrega + ", codEmpleado=" + codEmpleado + ", nombRecibe=" + nombRecibe + ", docuRecibe=" + docuRecibe + ", observaciones=" + observaciones + ", placaVehiculo=" + placaVehiculo + ", autoFitoSanitaria=" + autoFitoSanitaria + '}';
    }
