...
UPDATE NOTIFIACION_CORREO_V3 SET ACTIVO=1 WHERE ID_NOTIFICACION IN (1,3,4,9,10,11,12); -- NOTIFIACIÓN EN FASE DE PRUEBAS INTEGRALES.
...
SELECT F.* FROM DTE_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM IDENTIFICACION_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM DOCU_RELA_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM RECEPTOR_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM SHIPTO_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM OTROS_DOCU_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM VENTA_TERCERO_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM CUERPO_DOCU_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM CUERPO_TRIBUTO_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM RESUMEN_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM RESUMEN_TRIBUTO_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM EXTENSION_F_V3 F WHERE F.ID_DTE IN (33);
SELECT F.* FROM APENDICE_F_V3 F WHERE F.ID_DTE IN (33);
...
SELECT F.* FROM DTE_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM IDENTIFICACION_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM RECEPTOR_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM SHIPTO_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM OTROS_DOCU_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM VENTA_TERCERO_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM CUERPO_DOCU_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM CUERPO_TRIBUTO_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM RESUMEN_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM RESUMEN_TRIBUTO_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM EXTENSION_FEX_V3 F WHERE F.ID_DTE IN (24);
SELECT F.* FROM APENDICE_FEX_V3 F WHERE F.ID_DTE IN (24);
...
SELECT F.* FROM DTE_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM IDENTIFICACION_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM DOCU_RELA_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM RECEPTOR_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM SHIPTO_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM OTROS_DOCU_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM VENTA_TERCERO_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM CUERPO_DOCU_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM CUERPO_TRIBUTO_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM RESUMEN_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM RESUMEN_TRIBUTO_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM EXTENSION_NR_V3 F WHERE F.ID_DTE IN (1);
SELECT F.* FROM APENDICE_NR_V3 F WHERE F.ID_DTE IN (1);
...
WHERE (TRIM(F.SDKCO) IN (SELECT C.KCOO_JDE FROM EMISOR_KCOO_V3 C)) AND (F.SDDOC > 0) AND (TRIM(F.SDLTTR) NOT IN ('904','902','900','980')) AND (TRIM(F.SDDCTO) IN ('S3','C3','SD')) AND (TRIM(F.SDCRMD) IS NULL) AND (F.SDIVD = 123104);

SELECT F.* FROM DTE_FEX_V3 F WHERE F.DOCO_JDE IN (72959543,72959544,72959534,72959531) ORDER BY F.ID_DTE DESC;
SELECT F.* FROM CRPDTA.F5542FEL@JDEPY F WHERE F.FEDOCO IN (72959543,72959544,72959534,72959531);

UPDATE CRPDTA.F5542FEL@JDEPY SET FESTCD='000' WHERE FEDOCO IN (72959543,72959544,72959534,72959531);
COMMIT;
